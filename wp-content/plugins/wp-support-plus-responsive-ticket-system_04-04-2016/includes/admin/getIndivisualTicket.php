...
?>
<div style="width: 100%;">
    <button class="btn btn-primary wpsp_ticket_nav_btn" onclick="backToTicketFromIndisual();">« Back To Tickets</button>
    <?php if($current_user->has_cap('manage_options')){?>
    <button class="btn btn-danger wpsp_ticket_nav_btn" id="delbtn" onclick="deleteTicket(<?php echo $_POST['ticket_id'];?>);">Delete Ticket</button>
    <?php }?>
</div>
<h3 style="width: 100%;">[Ticket #<?php echo $_POST['ticket_id'];?>] <?php echo stripcslashes($ticket->subject);?></h3>
