...
final class SupportPlusAjax {
	function createNewTicket(){
		...
		$values=array(
				...
				'created_for'=>$_POST['create_ticket_category1'],
				'guest_name'=>$_POST['guest_name'],
				'guest_email'=>$_POST['guest_email'],
				'type'=>$_POST['type'],
				'status'=>'open',
				'cat_id'=>$_POST['create_ticket_category'],
				'complaint'=>$_POST['create_ticket_category2'],
				'account_issue'=>$_POST['create_ticket_category3'],
	...
	function replyTicket(){
		...
		$values=array(
				...
				'created_for'=>$_POST['reply_ticket_category1'],
				'update_time'=>current_time('mysql', 1),
