...
// Only last login modify the text from this option if we're on the wp-login page
...
//add_filter( 'submit_job_form_fields', 'frontend_add_day_field1' );
//add_filter( 'submit_job_form_fields', 'frontend_add_daytime_field' );
//add_filter( 'submit_job_form_fields', 'frontend_add_daytime_field1' );
//add_filter( 'submit_job_form_fields', 'frontend_add_daytime_field2' );
//add_filter( 'submit_job_form_fields', 'frontend_add_daytime_field3' );
//add_filter( 'submit_job_form_fields', 'frontend_add_daytime_field4' );
if($_GET['page_id'] == 11114){
  //	
 // add_filter( 'submit_job_form_fields', 'frontend_add_about_me' );
 // add_filter( 'submit_job_form_fields', 'frontend_add_my_education_and_exp' );
 // add_filter( 'submit_job_form_fields', 'frontend_add_previous_work_ref' );
 // add_filter( 'submit_job_form_fields', 'frontend_add_extra_additional_info' );	
 // add_filter( 'submit_job_form_fields', 'frontend_add_rate_hourly' );
}



 /*
function frontend_add_day_field1( $fields ) {
  $fields['job']['job_day1'] = array(
    'label'       => __( 'Select Day', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array( 0 	=> 'Monday',
...
function frontend_add_daytime_field( $fields ) {
  $fields['job']['job_0'] = array(
    'label'       => __( 'Monday', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array(1 => 'Morning 5 am To 12 am',
				2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
    'priority'    => 2.1,
	'id' => 'test_textsmall',
	'attributes' => array(
...
function frontend_add_daytime_field1( $fields ) {
  $fields['job']['job_1'] = array(
    'label'       => __( 'Tuesday', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array(1 => 'Morning 5 am To 12 am',
				2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
				'priority'    => 2.1
...
function frontend_add_daytime_field2( $fields ) {
  $fields['job']['job_2'] = array(
    'label'       => __( 'Wednesday', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array(1 => 'Morning 5 am To 12 am',
				2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
				'priority'    => 2.1
...
function frontend_add_daytime_field3( $fields ) {
  $fields['job']['job_3'] = array(
    'label'       => __( 'Thursday', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array(1 => 'Morning 5 am To 12 am',
				2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
				'priority'    => 2.1
...
function frontend_add_daytime_field4( $fields ) {
  $fields['job']['job_4'] = array(
    'label'       => __( 'Friday', 'job_manager' ),
    'type'        => 'multiselect',
	'options'     => array(1 => 'Morning 5 am To 12 am',
				2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
				'priority'    => 2.1
...
function frontend_add_about_me( $fields ) {
  $fields['company']['aboutme'] = array(
                    'label'       => __( 'About Me', 'wp-job-manager' ),
					'type'        => 'textarea',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 2.5
...
function frontend_add_my_education_and_exp( $fields ) {
  $fields['company']['my_exp'] = array(
                    'label'       => __( 'My Education and Experience', 'wp-job-manager' ),
					'type'        => 'textarea',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 2.5
...
function frontend_add_previous_work_ref( $fields ) {
  $fields['company']['prev_ref'] = array(
                    'label'       => __( 'Previous work references', 'wp-job-manager' ),
					'type'        => 'radio',
					'options'     => array(1 => 'Yes I can provide previous work refernces',
				2 => 'I am starting here,I do not have any references and please hide this field on my profile'),
...
function frontend_add_extra_additional_info( $fields ) {
  $fields['company']['add_info'] = array(
                    'label'       => __( 'Addition Information', 'wp-job-manager' ),
					'type'        => 'checkbox',
					'options'     => array(1 => 'Yes I can provide previous work refernces',
				2 => 'I am starting here,I do not have any references and please hide this field on my profile'),
...
function frontend_add_rate_hourly( $fields ) {
 $fields = array(
         'job' => array(
				'job_title1' => array(
					'label'       => __( 'Job Title1', 'wp-job-manager' ),
					'type'        => 'text',
					'required'    => true,
					'placeholder' => '',
					'priority'    => 1
				...
				'job_location1' => array(
					'label'       => __( 'Location1', 'wp-job-manager' ),
		...
		$fields['job']['holiday1'] = array(
                    'label'       => __( 'Weekdays(Mon to Fri)', 'wp-job-manager' ),
					'type'        => 'text',
					
					'placeholder' => 'Please select weekdays hourly rate',
					'priority'    => 2.7
        );
		$fields['job']['holiday2'] = array(
                    'label'       => __( 'Weekend(Sat to Sun)', 'wp-job-manager' ),
					'type'        => 'text',
					
					'placeholder' => 'Please select weekends hourly rate',
					'priority'    => 2.7
        );
		$fields['job']['holiday3'] = array(
                    'label'       => __( 'Bank Holiday', 'wp-job-manager' ),
					'type'        => 'text',
					
					'placeholder' => 'Please select bank holiday hourly rate',
					'priority'    => 2.7
        );
		$fields['job']['holiday4'] = array(
                    'label'       => __( 'Other Public Holiday', 'wp-job-manager' ),
					'type'        => 'text',
					
					'placeholder' => 'Please select public holiday hourly rate',
					'priority'    => 2.7
        );
		$fields['job']['holiday5'] = array(
                    'label'       => __( 'Over Night Booking', 'wp-job-manager' ),
					'type'        => 'text',
					
					'placeholder' => 'Please select over night hourly rate',
					'priority'    => 2.7
        );
  return $fields;
}
...
if( substr($post->post_mime_type, 0, 5) == 'image' ){
	...
	$field_value = get_post_meta($post->ID, "_to_ping", true);
	$form_fields["to_ping"] = array(
...
//print('<pre>'); print_r($post); print('</pre>');
	if( isset($attachment['to_ping']) ){
        // update_post_meta(postID, meta_key, meta_value);
        update_post_meta($post['ID'], '_to_ping', $attachment['to_ping']);
    }
    return $post;
