...
*/
?>
<?php return '<a title="'.__('send via mail', $this->pluginHook).'" target="_blank" href="mailto:?subject=Empfehlung:'.urldecode($this->shareTitle).'&body='.$this->shareUrl.'"><span class="delucksShareButton mail"><span class="counter">0</span></span></a>'; ?>