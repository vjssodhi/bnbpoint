...
<?php
return array(
	array('name' => 'username', 'type' => 'text', 'label' => __('@Username', $this->pluginHook)),
	array('name' => 'showFollowBox', 'type' => 'checkbox', 'label' => __('Show Follow-Box', $this->pluginHook)),
	array('name' => 'autoCloseSeconds', 'type' => 'text', 'label' => __('Auto close Follow-Box', $this->pluginHook), 'tooltip' => __('Automaticly fade out the Follow-Box in x seconds. (0 for no auto closing)', $this->pluginHook))
)
?>