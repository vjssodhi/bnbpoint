...
<?php
return array(
	array('name' => 'vanityUrl', 'type' => 'text', 'label' => __('Vanity URL', $this->pluginHook), 'tooltip' => __('http://www.facebook.com/[vanity-url]', $this->pluginHook)),
	array('name' => 'showLikeBox', 'type' => 'checkbox', 'label' => __('Show Like-Box', $this->pluginHook)),
	array('name' => 'autoCloseSeconds', 'type' => 'text', 'label' => __('Auto close Like-Box', $this->pluginHook), 'tooltip' => __('Automaticly fade out the Like-Box in x seconds. (0 for no auto closing)', $this->pluginHook))
)
?>