...
<?php
return array(
	array('name' => 'minWidth', 'type' => 'text', 'label' => __('Minimum image width', $this->pluginHook), 'tooltip' => __('Value in px - dont add px, em or %', $this->pluginHook)),
	array('name' => 'minHeight', 'type' => 'text', 'label' => __('Minimum image height', $this->pluginHook), 'tooltip' => __('Value in px - dont add px, em or %', $this->pluginHook)),
)
?>