...
*/
?>
<?php return '<a title="'.__('share on Google+', $this->pluginHook).'" target="_blank" href="https://plus.google.com/share?url='.$this->shareUrl.'&title='.$this->shareTitle.'"><span class="delucksShareButton google"><span class="counter">0</span></span></a>'; ?>