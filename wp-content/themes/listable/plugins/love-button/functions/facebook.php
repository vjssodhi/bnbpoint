...
*/
?>
<?php return '<a title="'.__('share on Facebook', $this->pluginHook).'" target="_blank" href="http://www.facebook.com/sharer.php?u='.$this->shareUrl.'&t='.$this->shareTitle.'"><span class="delucksShareButton facebook"><span class="counter">0</span></span></a>'; ?>