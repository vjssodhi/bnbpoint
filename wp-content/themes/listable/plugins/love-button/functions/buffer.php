...
*/
?>
<?php return '<a title="'.__('share on Buffer', $this->pluginHook).'" target="_blank" href="http://bufferapp.com/add?url='.$this->shareUrl.'&text='.$this->shareTitle.'"><span class="delucksShareButton buffer"><span class="counter">0</span></span></a>'; ?>