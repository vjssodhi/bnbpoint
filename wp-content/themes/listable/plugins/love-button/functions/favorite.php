...
*/
?>
<?php return '<a title="'.__('add to favorites', $this->pluginHook).'" target="_blank" href="#&url='.$this->shareUrl.'&title='.$this->shareTitle.'"><span class="delucksShareButton favorite"><span class="counter">0</span></span></a>'; ?>