...
*/
?>
<?php return '<a title="'.__('share on LinkedIn', $this->pluginHook).'" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url='.$this->shareUrl.'&title='.$this->shareTitle.'"><span class="delucksShareButton linkedin"><span class="counter">0</span></span></a>';?>