...
*/
?>
<?php return '<a title="'.__('share on StumpleUpon', $this->pluginHook).'" target="_blank" href="http://www.stumbleupon.com/submit?url='.$this->shareUrl.'&title='.$this->shareTitle.'"><span class="delucksShareButton stumbleupon"><span class="counter">0</span></span></a>'; ?>