...
*/
?>
<?php return '<a title="'.__('share on VKontakte', $this->pluginHook).'" target="_blank" href="http://vkontakte.ru/share.php?url='.$this->shareUrl.'&title='.$this->shareTitle.'"><span class="delucksShareButton vkontakte"><span class="counter">0</span></span></a>'; ?>