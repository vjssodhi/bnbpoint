...
<?php 
	...
	$sett = $this->options['networkSettings']['twitter'];
	return '<a title="'.__('tweet this', $this->pluginHook).'" target="_blank" href="https://twitter.com/intent/tweet?source=webclient'.(isset($sett['username']) && strlen(trim($sett['username'])) ? '&via='.$sett['username'].'&amp;' : '').'text='.$this->shareTitle.'&url='.$this->shareUrl.'"><span class="delucksShareButton twitter"><span class="counter">0</span></span></a>';
