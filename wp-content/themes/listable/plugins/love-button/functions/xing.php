...
*/
?>
<?php return '<a title="'.__('share on Xing', $this->pluginHook).'" target="_blank" href="https://www.xing.com/app/user?op=share;url='.$this->shareUrl.'"><span class="delucksShareButton xing"><span class="counter">0</span></span></a>'; ?>