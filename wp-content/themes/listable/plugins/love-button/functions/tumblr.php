...
*/
?>
<?php return '<a title="'.__('share on tumblr', $this->pluginHook).'" target="_blank" href="http://www.tumblr.com/share/link?url='.$this->shareUrl.'&name='.$this->shareTitle.'"><span class="delucksShareButton tumblr"><span class="counter">0</span></span></a>'; ?>