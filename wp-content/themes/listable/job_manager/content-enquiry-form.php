		...
		<div class="grid">
			<div class="grid__item  column-content  entry-content">
				<header class="entry-header">
                    ...
                    <div class="user_data">
                        <div class="user_image"><img src="<?php echo $user_info['user_image'][0];?>" alt="Smiley face" height="" width="90"> <?php echo $user_info['nickname'][0];?></div>
                      <div class="user_action_button">  <div class="btn_blk_1"> 
					   <button type="button">Send Inquiry Now</button>  <button type="button">Like This Job</button></div>  
