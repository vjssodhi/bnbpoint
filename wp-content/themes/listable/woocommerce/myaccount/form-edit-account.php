...
<div class="warning">
<p><span class="password-change-title"><?php _e( 'Profile Verification', 'woocommerce' ); ?></span><i class="fa fa-exclamation-triangle"></i>
<?php _e( 'Complete all point to earn Irishcare Seal of Approval on you Account.', 'woocommerce' ); ?></p>
</div>
...
<table border="1">
	...
	<tr>
<div class="progess">
        <p style="width:<?= 50?>%; border-top:4px solid #c3c3c3; width:100%;">
        </p>
</div>		
...
<ul>
<li>1.&nbsp;Complete Your Profile &nbsp;<b>+<?php echo "&nbsp;20%&nbsp;"; if($userid == 20){ echo '<span class="done">&nbsp;&nbsp;Done!</span>';}else
	{
...
?></b></li>
<li>3.&nbsp;Complete Your Tags &nbsp;<b>+<?php echo "&nbsp;20%&nbsp;"; if($userid == 20){ echo '<span class="done">&nbsp;&nbsp;Done!</span>';}else
	{
...
<p class="form-row form-row-half">
<h3 class="password-change-title"><?php _e( 'Only For Parents &nbsp;100%', 'woocommerce' ); ?>
<table border="1">
	<tr>
		<th>10%</th>
		<th>20%</th>
	...
	<tr>
<div class="progess">
        <p style="width:<?= 'here'?>%; border-top:4px solid #c3c3c3; width:100%;">
        </p>
</div>		
...
<ul>
<li>1.&nbsp;Complete Your Profile &nbsp;<b>+<?php echo "&nbsp;20%&nbsp;"; if($userid == 20){ echo '<span class="approve">&nbsp;&nbsp;Approved</span>';}else
	{
...
?></b></li>
<li>3.&nbsp;Complete Your Tags &nbsp;<b>+<?php echo "&nbsp;20%&nbsp;"; if($userid == 20){ echo '<span class="approve">&nbsp;&nbsp;Approved</span>';}else
	{
