...
//		'description' => '',
	...
	$fields['_job_day'] = array(
	  ...
	  $fields['_job_2'] = array(
		'label'       => esc_html__('Date', 'job_manager' ),
		'type'        => 'multiselect',
...
//	$fields['job']['job_description']['type']        = 'textarea';
    ...
    $fields['job']['job_0'] = array(
      'label'       => sprintf( 'Monday <span class="close" style="float: right;">X</span>', 'job_manager' ),
	  //'description' => sprintf( '<span class="description_tooltip left">%s</span>', esc_html__( 'Keep it short and descriptive as it will appear on search results instead of the link description', 'listable' ) ),
      'type'        => 'multiselect',
	  'options'     => array(1 => 'Morning 5 am To 12 am',2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
      'priority'    => 2.6,
	  'id' => 'test_textsmall',
	  'attributes' => array(
	        'class' => 'ff',
      ...
      $fields['job']['job_1'] = array(
		'label'       => sprintf( 'Tuesday  <span class="close" style="float: right;">X</span>', 'job_manager' ),
		'type'        => 'multiselect',
		'options'     => array(1 => 'Morning 5 am To 12 am',2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
		'priority'    => 2.6,
		'attributes' => array(
	  ...
	  $fields['job']['job_2'] = array(
		'label'       => __( 'Wednesday <span class="close" style="float: right;">X</span>', 'job_manager' ),
		'type'        => 'multiselect',
		'options'     => array(1 => 'Morning 5 am To 12 am',
					2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
					'priority'    => 2.6,
	   ...
	   $fields['job']['job_3'] = array(
		'label'       => __( 'Thursday <span class="close" style="float: right;">X</span>', 'job_manager' ),
		'type'        => 'multiselect',
		'options'     => array(1 => 'Morning 5 am To 12 am',
					2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
		'priority'    => 2.6
       ...
       $fields['job']['job_4'] = array(
		    'label'       => __( 'Friday <span class="close" style="float: right;">X</span>', 'job_manager' ),
		    'type'        => 'multiselect',
		    'options'     => array(1 => 'Morning 5 am To 12 am',2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
	 	    'priority'    => 2.6
	   );
	    $fields['job']['job_5'] = array(
		    'label'       => __( 'Saturday <span class="close" style="float: right;">X</span>', 'job_manager' ),
		    'type'        => 'multiselect',
		    'options'     => array(1 => 'Morning 5 am To 12 am',2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
	 	    'priority'    => 2.6
	   );
	   $fields['job']['job_6'] = array(
		    'label'       => __( 'Sunday <span class="close" style="float: right;">X</span>', 'job_manager' ),
		    'type'        => 'multiselect',
		    'options'     => array(1 => 'Morning 5 am To 12 am',2 => 'After Noon 12 pm To 5 pm',3 => 'Evening 5 pm  To 9 pm ',4 => 'Night 9 pm  To 5 am'),
	 	    'priority'    => 2.6
	   );
	   $fields['job']['des'] = array(
		'label'       => __( '', 'job_manager' ),
		'type'        => 'textarea',
		'priority'    => 2.6
	  );
	...
	$options = array(
        array(
            'id' => 'checkbox1',
            'type' => 'checkbox',
			'label'       =>  sprintf('Live out Nanny', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
        array(
            'id' => 'checkbox2',
            'type' => 'checkbox',
			'label'       => __( 'Nanny Housekeeper', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
		 array(
            'id' => 'checkbox3',
            'type' => 'checkbox',
			'label'       => __( '<span class="add_infor" style="float: right;">Additional Information</span>    Valid Visa', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
        array(
            'id' => 'checkbox4',
            'type' => 'checkbox',
			'label'       => __( 'Irish Passport', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
		 array(
            'id' => 'checkbox5',
            'type' => 'checkbox',
			'label'       => __( 'Eu Passport', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
		 array(
            'id' => 'checkbox6',
            'type' => 'checkbox',
			'label'       => __( 'Playgound', 'wp-job-manager' ),
            'priority'    => 2.8
         ),
    );	
		...
		$fields['company']['prev_ref'] = array(
			...
			'type'        => 'radio',
			'options'     => array(1 => 'Yes I can provide previous work refernces',2 => 'I am starting here,I do not have any references and please hide this field on my profile'),
			'placeholder' => '',
			'priority'    => 2.7
        );
		
	/*for($i=0;$i<10;$++){	
		$fields['company']['dd'] = array(
            'label'       => __( 'Addition Information', 'wp-job-manager' ),
			'type'        => 'checkbox',
			//'options'     => array($i => 'Yes I can provide previous work refernces',2 => 'I am starting here,I do not have any references and please hide this field on my profile'),
			'placeholder' => '',
			'priority'    => 2.7
        );
	  }	*/
	...
	$fields['job']['job_location']['priority']    = 2.9;
	...
	$fields['company']['main_image']['priority']           = 2.9;
	...
	if($_GET['page_id'] == 10){
          $fields['company']['datepicker'] = array(
            'label'       =>   __( 'Close this job', 'wp-job-manager' ),
			'type'        =>   'text',
			'date'        =>   true,
	...
	$fields['company']['company_logo']['priority']    = 2.9;
